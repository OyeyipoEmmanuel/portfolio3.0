...
export const projects: ProjectsDataType[] = [
  ...
  {
    header: "My DSA Space",
    text: "What do you do when you're bored? games? outdoor events?.... For me, I continue learing, growing, diving deeper in my problem solving skills. I don't want to be that kind of engineer that just writes code for the sake of writing. So I do dsa, leetcode, neetcode etc to sharpen my DSA skills",
    githubLink: "https://github.com/OyeyipoEmmanuel/dsa-swe-stuffs",
    liveLink: "",
    imageSrc: "/assets/images/dsa.webp",
    videoSrc: null,
    stack: ["DSA", "Javascript", "Typescript"],
  },
  {
    header: "Deleo Shop",
